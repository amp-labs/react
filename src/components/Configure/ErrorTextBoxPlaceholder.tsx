...
export function ErrorTextBoxPlaceholder({ message }: ErrorTextBoxPlaceholderProps) {
  return <Box minHeight="300px" padding="30px" display="flex" flexDirection="column" justifyContent="space-evenly" alignItems="center">
    ...
    <Box boxSizing="border-box" display="flex" justifyContent="center" alignItems="center" align-self="stretch" padding="12px 50px 12px 50px" borderRadius="8px" border="2px solid #FECACA" background="#FEF2F2">
      <Text color="#991B1B">
        {message}
      </Text>
    </Box>
