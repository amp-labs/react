...
export * from './UpdateConnectionRequestBasicAuth';
export * from './UpdateConnectionRequestOauth2ClientCredentials';
export * from './UpdateConnectionRequestOauth2Password';
