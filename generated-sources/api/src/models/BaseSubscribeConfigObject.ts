 ...
 * 
 * @export
 * @interface BaseSubscribeConfigObject
 */
export interface BaseSubscribeConfigObject {
    /**
...
/**
 * Check if a given object implements the BaseSubscribeConfigObject interface.
 */
export function instanceOfBaseSubscribeConfigObject(value: object): boolean {
    let isInstance = true;
...
export function BaseSubscribeConfigObjectFromJSON(json: any): BaseSubscribeConfigObject {
    return BaseSubscribeConfigObjectFromJSONTyped(json, false);
}

export function BaseSubscribeConfigObjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): BaseSubscribeConfigObject {
...
export function BaseSubscribeConfigObjectToJSON(value?: BaseSubscribeConfigObject | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
