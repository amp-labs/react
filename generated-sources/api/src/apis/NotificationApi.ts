...
import type {
  ...
  ListEventTopicRoutes200Response,
  ListTargets200Response,
  ListTopicTargetRoutes200Response,
...
import {
    ...
    ListEventTopicRoutes200ResponseFromJSON,
    ListEventTopicRoutes200ResponseToJSON,
    ListTargets200ResponseFromJSON,
    ListTargets200ResponseToJSON,
    ListTopicTargetRoutes200ResponseFromJSON,
    ListTopicTargetRoutes200ResponseToJSON,
...
export interface NotificationApiInterface {
     ...
     * @memberof NotificationApiInterface
     */
    listEventTopicRoutesRaw(requestParameters: ListEventTopicRoutesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListEventTopicRoutes200Response>>;

    /**
     * List notification event-topic routes with optional filtering for topic ID and event type.
     */
    listEventTopicRoutes(requestParameters: ListEventTopicRoutesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListEventTopicRoutes200Response>;
     ...
     * @memberof NotificationApiInterface
     */
    listTargetsRaw(requestParameters: ListTargetsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListTargets200Response>>;

    /**
     * List notification targets
     */
    listTargets(requestParameters: ListTargetsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListTargets200Response>;
     ...
     * @memberof NotificationApiInterface
     */
    listTopicTargetRoutesRaw(requestParameters: ListTopicTargetRoutesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListTopicTargetRoutes200Response>>;

    /**
     * List notification topic-target routes
     */
    listTopicTargetRoutes(requestParameters: ListTopicTargetRoutesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListTopicTargetRoutes200Response>;
     ...
     * @memberof NotificationApiInterface
     */
    listTopicsRaw(requestParameters: ListTopicsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListTopics200Response>>;

    /**
     * List notification topics
     */
    listTopics(requestParameters: ListTopicsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListTopics200Response>;
...
export class NotificationApi extends runtime.BaseAPI implements NotificationApiInterface {
     ...
     * List notification event-topic routes with optional filtering for topic ID and event type.
     */
    async listEventTopicRoutesRaw(requestParameters: ListEventTopicRoutesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListEventTopicRoutes200Response>> {
        if (requestParameters.projectIdOrName === null || requestParameters.projectIdOrName === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ListEventTopicRoutes200ResponseFromJSON(jsonValue));
    }

    /**
     * List notification event-topic routes with optional filtering for topic ID and event type.
     */
    async listEventTopicRoutes(requestParameters: ListEventTopicRoutesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListEventTopicRoutes200Response> {
     ...
     * List notification targets
     */
    async listTargetsRaw(requestParameters: ListTargetsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListTargets200Response>> {
        if (requestParameters.projectIdOrName === null || requestParameters.projectIdOrName === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ListTargets200ResponseFromJSON(jsonValue));
    }

    /**
     * List notification targets
     */
    async listTargets(requestParameters: ListTargetsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListTargets200Response> {
     ...
     * List notification topic-target routes
     */
    async listTopicTargetRoutesRaw(requestParameters: ListTopicTargetRoutesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListTopicTargetRoutes200Response>> {
        if (requestParameters.projectIdOrName === null || requestParameters.projectIdOrName === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ListTopicTargetRoutes200ResponseFromJSON(jsonValue));
    }

    /**
     * List notification topic-target routes
     */
    async listTopicTargetRoutes(requestParameters: ListTopicTargetRoutesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListTopicTargetRoutes200Response> {
