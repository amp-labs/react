...
export interface NotificationApiInterface {
     ...
     * @param {'read.backfill.done' | 'connection.created' | 'connection.error' | 'installation.created' | 'installation.updated' | 'installation.deleted' | 'read.schedule.paused' | 'destination.webhook.disabled'} [eventType] Filter by notification event type.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof NotificationApiInterface
     */
