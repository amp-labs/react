...
export interface InstallationApiInterface {
    ...
    /**
     * Updates a single object\'s configuration within an installation using JSON Patch syntax (RFC 6902). Applies JSON Patch operations (add, remove, replace) to a specific object\'s config. Supports updating read, subscribe, and write object configurations. 
     * @summary Update an installation object
     * @param {string} projectIdOrName The Ampersand project ID or project name.
     * @param {string} integrationId The integration ID.
     * @param {string} objectName The object name whose config content will be patched.
